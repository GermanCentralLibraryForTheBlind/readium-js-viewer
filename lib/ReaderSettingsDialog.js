    ...
    var initDialog = function (reader) {
        ...
        $('#settings-dialog').on('show.bs.modal', function () { // IMPORTANT: not "shown.bs.modal"!! (because .off() in library vs. reader context)
            ...
            Settings.get('reader', function (readerSettings) {
                ...
                if (readerSettings.theme == "vancouver-theme") {
                    $('#vancouver-theme-radio').prop('checked', true);
                }
                else if (readerSettings.theme == "default-theme") {
                    $('#default-theme-radio').prop('checked', true);
                }
                else if (readerSettings.theme == "night-theme") {
                    $('#night-theme-radio').prop('checked', true);
                }
                else if (readerSettings.theme == "parchment-theme") {
                    $('#parchment-theme-radio').prop('checked', true);
                }
                else if (readerSettings.theme == "ballard-theme") {
                    $('#ballard-theme-radio').prop('checked', true);
                }
                else if (readerSettings.theme == "parchment-theme") {
                    $('#parchment-theme-radio').prop('checked', true);
                }
